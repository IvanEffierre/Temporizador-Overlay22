...
Public Class FormEULA
    ...
    Private Sub btnAceitar_Click(
        ...
        ' Segurança adicional
        If Not chkAceite.Checked Then

            MessageBox.Show(
                "Você precisa marcar que leu e concorda com os termos.",
                "Temporizador Overlay",
                MessageBoxButtons.OK,
        ...
        ' ==========================================
        ' REGISTRA QUE O USUÁRIO ACEITOU O EULA
        ' ==========================================

        My.Settings.EULA_Aceito = True

        My.Settings.Save()


        ' Informa ao formulário principal
        ' que o EULA foi aceito
    ...
    Private Sub btnRecusar_Click(
        ...
        MessageBox.Show(
            "O programa será encerrado porque os termos de uso não foram aceitos.",
            "Temporizador Overlay",
            MessageBoxButtons.OK,
            MessageBoxIcon.Information
        )
